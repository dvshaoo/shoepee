...
('Nike', 'JT 1', 1, 1, 1, 1, 1, 0, 0, 0, 129.99, 55, 'Jayson Tatum''s first signature shoe. Built for scoring from anywhere.', '1702915082-JT 1.jpg', 'FALSE', 'Just In'),
('Nike', 'Luka 2', 1, 1, 1, 1, 1, 1, 0, 0, 139.99, 65, 'Luka Doncic''s 2nd signature shoe. Crafty, creative, and court-ready.', '1702915182-Luka 2.jpg', 'FALSE', 'Bestseller'),
('Nike', 'Jordan 38', 1, 1, 1, 1, 1, 1, 1, 0, 199.99, 50, 'The Air Jordan 38. Latest in the iconic line with updated performance tech.', '1702915208-Jordan 38.jpg', 'FALSE', 'Just In'),
('Nike', 'Jordan Legacy 312 Low', 1, 1, 1, 1, 1, 0, 0, 0, 149.99, 60, 'A hybrid of Jordan 1, 3, and Air Alpha Force. Don C''s legacy lives on.', '1702915247-Jordan Legacy 312 Low.webp', 'FALSE', 'Just In'),
('Adidas', 'Powerpuff A', 1, 1, 1, 1, 1, 0, 0, 0, 129.99, 35, 'Powerpuff Girls x Adidas Forum Low collaboration. Bold, colorful, and fun.', '1702915786-PowerpuffA.webp', 'FALSE', 'Just In'),
('Adidas', 'Powerpuff B', 1, 1, 1, 1, 1, 0, 0, 0, 129.99, 35, 'Powerpuff Girls x Adidas Forum Low collaboration. Blossom-inspired colorway.', '1702915770-Powerpuffb.webp', 'FALSE', 'Just In'),
('Adidas', 'Powerpuff C', 1, 1, 1, 1, 1, 0, 0, 0, 129.99, 35, 'Powerpuff Girls x Adidas Forum Low collaboration. Buttercup-inspired colorway.', '1703021412-PowerpuffC.webp', 'FALSE', 'Just In'),
